...
GameInputs read_inputs()
{
    ...
    hw_in.b1 = button3; //top button on breadboard is  connected to p23
    hw_in.b2 = button2; //middle button on breadboard is  connected to p22
    hw_in.b3 = button1; //bottom button ob breadboard is  connected to p21
    
    acc.readXGravity(&hw_in.ax);
    acc.readYGravity(&hw_in.ay);
    acc.readZGravity(&hw_in.az);
